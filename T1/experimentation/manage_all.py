...
plt.plot(T_SIZE, y_linear_plus_binary_io, plot_style, color='brown', label="Búsqueda lineal con bsearch")
plt.plot(T_SIZE, y_linear_plus_merge_io, plot_style, color='black', label="Búsqueda lineal con merge")
plt.title("RESULTADOS EXPERIMENTO CANTIDAD I/O NO CRITICAR YET")
plt.xlabel("soy un eje x")
...
plt.plot(T_SIZE, y_linear_plus_merge_t, plot_style, color='brown', label="Búsqueda lineal con bsearch")
plt.plot(T_SIZE, y_linear_plus_binary_t, plot_style, color='black', label="Búsqueda lineal con merge")
plt.title("RESULTADOS EXPERIMENTO T NO CRITICAR YET")
plt.xlabel("soy un eje x")
plt.ylabel("soy un eje y")
plt.legend()
plt.show()
